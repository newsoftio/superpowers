...
- **Every substantive reply leads with a `TLDR;` — and then delivers the full reply.** The TLDR summarizes the reply; it never replaces it. After the TLDR block, write the complete answer exactly as you would have without one — full reasoning, evidence, and detail. Litmus test: delete the TLDR and the reply must still stand complete on its own; if a fact appears only in the TLDR, the body is missing it.
